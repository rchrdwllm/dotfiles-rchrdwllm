...
paru -S firefox-developer-edition discord betterdiscordctl betterdiscord-git telegram-desktop code code-features obs-studio vlc apple-music-desktop minecraft-launcher syncthing syncthing-gtk github-desktop-bin
